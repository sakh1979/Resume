...
%------------------------------------------------------------------------------
\section{Summary}
  \cvlistitem{11+ years of professional software engineering experience,
...
\section{Technical Skills}
  ...
  \cvline{Technologies}
         {REST WS, Hibernate, Spring, EJB3, JPA, AJAX, JSP, Servlet,
         Structs, MQ Messaging}
  \cvline{OS Platforms}
...
\section{Experience}
  ...
  \subsection{Professional Experience}
     ...
     {\begin{itemize}
         \item Lead a team of developers in the Global Cyber Security group
         \item Mentored and guided developers to understand proper software
               engineering practices
         \item Technologies used: Java 8, MS--SQL, Git, Spring Boot, Rabbit MQ,
               HTML5, CSS3, jQuery, Jenkins
     \end{itemize}}
