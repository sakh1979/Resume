...
\section{Summary}
  \cvlistitem{8+ years of professional software engineering experience,
              delivering a consumer-facing web application with a service
              oriented architecture.}
  \cvlistitem{Result oriented, self managed --- proven track record of
              delivering with minimal oversight.}
  \cvlistitem{Proven expertise in Java based (highly scalable, distributed,
              and tiered) web application.}
  \cvlistitem{Broad knowledge of software engineering concepts, 
              technologies, methodologies, and practices.}
  \cvlistitem{Proficient in Linux/UNIX environments, shell scripting, Java 
              ...
              Systems such as Oracle, and software deployments.}
  \cvlistitem{Experience working on complex data-driven JEE application 
              ...
              in technologies such as Java, Spring, REST, Hibernate, JUnit,
              Git, Maven, Ant, etc...}
  ...
  \cvlistitem{Knowledge of ACH, Credit Card processing, and Accounting System.}
...
\section{Experience}
  ...
  \subsection{Professional Experience}
     \cventry{2013--Present}{Principal Java Developer}
     ...
     \cventry{2008--2012}{Senior Java Developer}
     {\textsc{Xerox}}{Austin, TX}{}
     {\begin{itemize}
     ...
     \cventry{2006--2007}{Java Developer}
