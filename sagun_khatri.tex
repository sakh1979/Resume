...
%------------------------------------------------------------------------------
\section{Summary}
  \cvlistitem{12+ years of professional software engineering experience in
              delivering consumer-facing web applications with service
...
\section{Technical Skills}
  \cvline{Languages}
         {Java, Clojure, Shell Scripts, HTML5, CSS3}
  \cvline{Database}
         {Oracle, PostgreSQL, MS--SQL}
  \cvline{Technologies}
         {Spring Framework, Hibernate, EJB3, JPA, jQuery, Kafka, RabbitMQ}
  \cvline{OS Platforms}
         {Linux, Mac OS X (Tiger--Yosemite), Windows 95--Windows 7}
  \cvline{App. Servers}
...
\section{Experience}
  ...
  \subsection{Professional Experience}
     ...
     {\begin{itemize}
         \item Lead team on the Global Cyber Security group that is
               responsible for developing highly reliable and secure
               software.
         \item Full stack development across numerous codebase.
         \item Collaboration with other devlopment teams on feature
         ...
         \item Technologies used: Java 8, Spring Boot, Cassandra,
               HDFS, MS--SQL, Git, Kafka, HTML5, CSS3, jQuery, Jenkins
     \end{itemize}}
